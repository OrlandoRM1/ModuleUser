...
<div class="container">
			<div class="row">
				<h3 style="text-align:center">MODIFICAR REGISTRO DE PERSONA</h3>
			</div>
			
			<form class="form-horizontal" method="POST" action="updatePersona.php" autocomplete="off">
                ...
                <input type="hidden" id="idPersona" name="idPersona" value="<?php echo $row['idPersona']; ?>" />
